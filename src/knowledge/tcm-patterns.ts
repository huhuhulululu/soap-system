...
export const TCM_PATTERNS: Record<string, TCMPattern> = {
  'Qi Stagnation': {
    ...
    pulseChineseName: '弦脉',
    treatmentPrinciples: ['moving qi', 'regulates qi', 'dredging channel and activating collaterals'],
  ...
  'Blood Stasis': {
    ...
    pulseChineseName: '涩脉',
    treatmentPrinciples: ['activating Blood circulation to dissipate blood stagnant', 'promote circulation, relieves pain'],
  ...
  'Qi Stagnation, Blood Stasis': {
    ...
    treatmentPrinciples: ['promote circulation, relieves pain', 'moving qi', 'activating Blood circulation to dissipate blood stagnant'],
    mainSymptoms: ['fixed pain with distension', 'worse with pressure', 'emotional stress worsens']
  },
  'Liver Qi Stagnation': {
  ...
  'Blood Deficiency': {
    ...
    treatmentPrinciples: ['nourishing blood', 'activate blood and relax tendons'],
  ...
  'Qi & Blood Deficiency': {
    ...
    treatmentPrinciples: ['tonifying qi and blood', 'strengthening muscles and bone'],
    mainSymptoms: ['fatigue', 'dizziness', 'pale complexion', 'shortness of breath']
  },
  'Wind-Cold Invasion': {
    ...
    treatmentPrinciples: ['expelling pathogens', 'dispelling cold', 'dredging channel and activating collaterals'],
  ...
  'Cold-Damp + Wind-Cold': {
    ...
    treatmentPrinciples: ['dispelling cold, drain the dampness', 'expelling pathogens'],
  ...
  'LV/GB Damp-Heat': {
    ...
    treatmentPrinciples: ['clear heat', 'dispelling the flame', 'clear damp-heat'],
  ...
  'Phlegm-Damp': {
    ...
    treatmentPrinciples: ['drain the dampness', 'resolve stagnation', 'dredging channel and activating collaterals'],
  ...
  'Damp-Heat': {
    ...
    treatmentPrinciples: ['clear damp-heat', 'drain the dampness', 'clear heat'],
  ...
  'Kidney Yang Deficiency': {
    ...
    treatmentPrinciples: ['warming kidney yang', 'strengthening muscles and bone'],
    mainSymptoms: ['cold limbs', 'fatigue', 'frequent urination', 'low back pain']
  },
...
// 验证舌象是否匹配证型
export function isTongueMatchPattern(tongue: string, patternName: string): boolean {
...
// 验证脉象是否匹配证型
export function isPulseMatchPattern(pulse: string, patternName: string): boolean {
  const pattern = TCM_PATTERNS[patternName]
  if (!pattern) return false
