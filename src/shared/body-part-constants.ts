...
export const BODY_PART_ROM: Record<string, ROMMovement[]> = {
  ...
  ELBOW: [
    ...
    { movement: "Left side flexion", normalDegrees: 45, difficulty: "EASY" },
    { movement: "Rt side flexion", normalDegrees: 45, difficulty: "EASY" },
    { movement: "Left side rotation", normalDegrees: 80, difficulty: "MEDIUM" },
    { movement: "Right side rotation", normalDegrees: 80, difficulty: "MEDIUM" },
  ],
  WRIST: [
